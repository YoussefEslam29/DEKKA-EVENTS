...
export function EventCard({
  ...
  return (
    <Link
      ...
      className="group flex overflow-hidden rounded-[4px] border border-line bg-paper transition-colors hover:border-gold"
    >
      <div className="flex w-20 shrink-0 flex-col items-center justify-center border-e border-line bg-ink px-2 py-4 text-cream md:w-24">
        ...
        <span className="mt-2 text-[0.65rem] text-cream/60">{parts.year}</span>
      </div>
      ...
      <div className="min-w-0 flex-1 p-4">
        <div className="mb-1 flex flex-wrap items-center gap-2">
          <h3 className="truncate text-lg font-bold group-hover:text-gold-deep">
